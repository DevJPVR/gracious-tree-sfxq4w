...
const appId = "8YQ425E53Z";
const apiKey = "c0a8495125827569227f1f9f12b8c0b0";
    ...
    return [
      {
        ...
        getItems({ query }) {
          return getAlgoliaFacets({
            ...
            queries: [
              {
                indexName: "devalgolia_searchable_posts",
                facet: "taxonomies.regions",
                params: {
                  facetQuery: query,
                  maxFacetHits: 5,
        ...
        templates: {
          header() {
            return (
              <Fragment>
                <span className="aa-SourceHeaderTitle">Regions</span>
